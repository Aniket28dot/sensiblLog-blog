  ...
  return (
    <>
      <div className="bg-white">
        <div className="text-slate-700 relative flex max-w-screen-xl flex-col overflow-hidden pt-5 pb-8 md:mx-auto md:flex-row md:items-center">
          <h3 className="flex cursor-pointer items-center whitespace-nowrap text-2xl font-black">
            <span className="mr-2 text-4xl text-black-500">
            ...
            <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
              ...
              <li className="md:mr-12">
                {loginStatus.status === 'authenticated' ?
                  (<button onClick={() => signOut()} className="rounded-full border-2 border-gray-500 px-6 py-1 text-gray-600 transition-colors hover:bg-gray-500 hover:text-white">Sign Out</button>) :
                  (<button onClick={() => signIn()} className="rounded-full border-2 border-gray-500 px-6 py-1 text-gray-600 transition-colors hover:bg-gray-500 hover:text-white">Login</button>)
                }
              </li>
            </ul>
          </div>
